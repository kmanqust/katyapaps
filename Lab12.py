...
class BankAPITXT(BankAPI):
    ...
    def __InsertData(self, result0):
        with open('Info.txt', 'a') as file:
            file.write(f'{result0[0]} {result0[1]} {result0[2]} {result0[3]} \n')
...
class AbstractFactory:
    def create_gen_and_api(self):
        pass


class TxtFactory(AbstractFactory):
    def create_gen_and_api(self):
        return BankAPITXT(), GeneratorTXT()


class SQLFactory(AbstractFactory):
    def create_gen_and_api(self):
        return BankAPISQL(), GeneratorSQL()


Factory = TxtFactory()
Bank1, Generator1 = Factory.create_gen_and_api()
Bank1.getInfo(3398829122519118)
